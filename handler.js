...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;🔥𝐎𝐅𝐂 𝐂𝐇𝐀𝐑𝐋𝐘🔥;;;\nFN:𝐁𝐫𝐮𝐧𝐨 𝐒𝐨𝐛𝐫𝐢𝐧𝐨 👑\nORG:𝐁𝐫𝐮𝐧𝐨 𝐒𝐨𝐛𝐫𝐢𝐧𝐨 👑\nTITLE:\nitem1.TEL;waid=593960070183:+593989461535\nitem1.X-ABLabel:🔥𝐎𝐅𝐂 𝐂𝐇𝐀𝐑𝐋𝐘🔥\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:🔥𝐎𝐅𝐂 𝐂𝐇𝐀𝐑𝐋𝐘🔥\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '🔥𝐎𝐅𝐂 𝐂𝐇𝐀𝐑𝐋𝐘🔥👑', contacts: [{ vcard }] }}, {quoted: callmsg})
...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: 'ɢᴏᴋᴜ ʙᴏᴛ - ʙᴏᴛ', thumbnail: imagen1, sourceUrl: 'https://github.com/Goku2812/BOT2GOKU' }}}}, { quoted: m })
